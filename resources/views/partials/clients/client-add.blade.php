            ...
            <select name="sex" id="sex" required="required" class="form-control">
             ...
             <h5>Services</h5>
                ...
                @foreach($services as $service)
                    <div class="form-check form-check-inline" style="display: -webkit-inline-box"><input type="checkbox" class="form-check-input" name="services[]" value="{{ $service->id }}" id="service_{{ $service->id }}"> <label  class="form-check-label" for="service_{{ $service->id }}">{{ $service->service_name }}</label></div>
                @endforeach
            <br><br>
