...
<table style="margin:0 auto; width:75%" cellspacing=0>
    ...
    <tbody>
        ...
        <tr>
            <td style="border-bottom:1px solid #999; border-right:1px solid #999">{{ $client['last'] }}, {{ $client['first'] }}</td>
            <td style="border-bottom:1px solid #999; border-right:1px solid #999" colspan="2" valign="top">
